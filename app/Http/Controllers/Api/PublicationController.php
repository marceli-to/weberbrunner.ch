...
class PublicationController extends Controller
{
	...
	public function store(StorePublicationRequest $request)
	{
		...
		return new PublicationResource($publication->load(['location', 'attributes', 'blocks.media', 'blocks.links.linkedProject', 'media', 'teaser', 'og', 'download']));
	}
	...
	public function show(Publication $publication)
	{
		...
		$publication->load(['location', 'attributes', 'blocks.media', 'blocks.links.linkedProject', 'media', 'teaser', 'og', 'download']);
