...
<x-layout.partials.body>
  ...
  <div class="md:grid md:grid-cols-12 w-full flex-1 px-20 lg:px-40">
    ...
    <div class="md:col-span-3 2xl:col-span-2 bg-yellow-50">
    ...
    <div class="md:col-span-9 2xl:col-span-10 bg-green-50">

      <x-layout.partials.header class="bg-red-50 min-h-75 md:min-h-140 lg:min-h-250 flex flex-col md:flex-row md:items-start md:justify-end gap-y-30 md:gap-y-0 md:gap-x-30 py-20 lg:pt-40">
