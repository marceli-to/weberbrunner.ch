...
export function useCan() {
	...
	const canDeletePortrait = computed(() => isAdmin.value || isEditor.value)
	...
	return {
		...
		canCreate, canUpdate, canDelete, canDeletePortrait, canRestore, canReorder, canUpload, canPublish,
